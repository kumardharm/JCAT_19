...
public class AssessmentController implements IAssessmentController{
	...
	@Override
	public boolean saveAnswers(List<AnswerModel> answerModels, int applicationId) throws SystemExceptions, OptionTextNotNullException {
		return answerService.saveAnswers(answerModels,applicationId);
	}

	@Override
	public void finalized(List<AnswerModel> answerModels, int applicationId, int assessmentStage) throws SystemExceptions, OptionTextNotNullException {
